...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath }/sys/detail/style/images/title_arrow.gif"/> 添加新菜品
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
                        ...
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="m_price" class="InputStyle" value=""/> *</td>
						</tr>
