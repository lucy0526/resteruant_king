...
#Menu .level1 .level1Style {
  background: url("${pageContext.request.contextPath }/sys/detail/style/images/img/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url(${pageContext.request.contextPath }/sys/detail/style/images/img/menu_arrow_single.gif);
    ...
    <ul id="Menu">
	    <li class="level1">
            <div onClick="menuClick(this);" class="level1Style">
				<img src="${pageContext.request.contextPath }/sys/detail/style/images/func20001.gif" class="Icon" /> 
				系统菜单
			</div>
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/tableServlet?method=list">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                ...
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/orderServlet?method=list">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
