...
#Head_1 {
    background: url("${pageContext.request.contextPath }/sys/detail/style/images/img/top_head1_bg.gif") repeat-x scroll 0 0 transparent;
    height: 64px;
    margin: 0 auto;
    width: 100%;
}
...
#Head_2 {
   background: url("${pageContext.request.contextPath }/sys/detail/style/images/img/top_head2_bg.gif") repeat-x scroll 0 0 transparent;
...
<body>
	...
	<div id="Head_1">
		<!-- 标题 -->
		<div id="Head_1_Logo">
			<b style="font-family: '黑体'">点餐平台信息管理系统</b> <!-- <img border="0" src="${pageContext.request.contextPath }/sys/detail/style/images/logo.png" /> -->
        </div>
		<!-- 欢迎用户的文字 -->
		<div id="Head_1_UserWelcome">
			<img border="0" width="13" height="14" src="${pageContext.request.contextPath }/sys/detail/style/images/user.gif" /> 
			您好<b></b>
		</div>
		<!-- 一些链接按钮 -->
	</div>
    ...
    <div id="Head_2">
		...
		<div class="Head2_FunctionList" style="float:left">
			<a href="javascript: window.parent.right.history.back();">
				<img src="${pageContext.request.contextPath }/sys/detail/style/images/Header_back.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>后退</b>
			</a>
			<a href="javascript: window.parent.right.history.forward();">
				<img src="${pageContext.request.contextPath }/sys/detail/style/images/Header_forward.gif" width="24" height="24" style="margin-top: -8px;"/>
				<b>前进</b>		
			</a>
        </div>
