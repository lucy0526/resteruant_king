...
<body>
		...
		<div id="TitleArea_Title">
			<div id="TitleArea_Title_Content">
				<img border="0" width="13" height="13"
					src="${pageContext.request.contextPath }/sys/detail/style/images/title_arrow.gif" /> 菜系列表
			</div>
		</div>
	...
	<!-- 过滤条件 -->
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/foodTypeServlet" method="post">
			<input type="hidden" name="method" value="getFoodType">
	...
	<div id="MainArea">
					...
					<c:when test="${not empty requestScope.list}">
						<c:forEach var="foodType" items="${requestScope.list}">
							<tr>
								...
								<td>
									<a href="${pageContext.request.contextPath }/foodTypeServlet?id=${foodType.id}&method=updateView" class="FunctionButton">更新</a> 
		...
		<div id="TableTail" align="center">
			<div class="FunctionButton">
				<a href="${pageContext.request.contextPath }/sys/detail/foodType/addFoodType.jsp">添加</a> 
			</div>
		</div>
	</div>
</body>
